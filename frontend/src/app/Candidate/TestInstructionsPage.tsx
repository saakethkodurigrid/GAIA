...
const TestInstructionsPage = () => {
  ...
  const handleStartTour = () => {
    navigate('/test/permissions?from=tour');
  };
      ...
      <div className="flex-1 flex overflow-hidden w-full" style={{ backgroundColor: '#FFFBF0' }}>
        ...
        <div className="w-96 border-r-2 border-black flex flex-col p-6" style={{ backgroundColor: '#FFFBF0' }}>
          <div className="flex-1 flex flex-col justify-center">
            <p className="text-sm text-gray-600 mb-2">Welcome to your</p>
        ...
        <div className="flex-1 flex flex-col justify-center overflow-y-auto p-8" style={{ backgroundColor: '#FFFBF0' }}>
          <div>
            ...
            <ol className="space-y-4 mb-8 text-gray-700">
              <li className="flex gap-3">
                ...
                <span>Find a quiet and comfortable place where you won't be interrupted.</span>
              </li>
              <li className="flex gap-3">
              ...
              <li className="flex gap-3">
                <span className="font-semibold text-gray-900 min-w-[24px]">5.</span>
                <span>
