                    ...
                    <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-base font-semibold text-blue-900">Uploading resumes...</span>
                        </div>
                        ...
                        <tbody>
                          {completedInterviews.map((interview) => (
                            <tr key={interview.candidate_id} className="border-b border-gray-100 hover:bg-gray-50">
                              ...
                              <td className="py-3 px-4 text-base text-gray-900">{interview.name}</td>
                              <td className="py-3 px-4 text-base text-gray-600">{interview.email_id}</td>
                              <td className={`py-3 px-4 text-base font-medium ${interview.resume_score !== null && interview.resume_score >= 60 ? 'text-green-600' : 'text-gray-600'}`}>
                                {formatInterviewScore(interview.resume_score)}
                              </td>
